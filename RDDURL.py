...
if __name__ == "__main__":
    ...
    text_file_path = "times/elapsed_time_RDDURL_nodes=" + str(num_nodes) + ".txt"
    ...
    content = f"Elapsed Time: {elapsed_time:.2f} seconds | Num Nodes: {num_nodes} | Method: RDD with URL partitioning\n"
